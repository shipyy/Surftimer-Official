...
char sql_updateStageTimes[] = "UPDATE ck_checkpoints SET cp_stagetime_1='%f', cp_stagetime_2='%f', cp_stagetime_3='%f', cp_stagetime_4='%f', cp_stagetime_5='%f', cp_stagetime_6='%f', cp_stagetime_7='%f', cp_stagetime_8='%f', cp_stagetime_9='%f', cp_stagetime_10='%f', cp_stagetime_11='%f', cp_stagetime_12='%f', cp_stagetime_13='%f', cp_stagetime_14='%f', cp_stagetime_15='%f', cp_stagetime_16='%f', cp_stagetime_17='%f', cp_stagetime_18='%f', cp_stagetime_19='%f', cp_stagetime_20='%f', cp_stagetime_21='%f', cp_stagetime_22='%f', cp_stagetime_23='%f', cp_stagetime_24='%f', cp_stagetime_25='%f', cp_stagetime_26='%f', cp_stagetime_27='%f', cp_stagetime_28='%f', cp_stagetime_29='%f', cp_stagetime_30='%f', cp_stagetime_31='%f', cp_stagetime_32='%f', cp_stagetime_33='%f', cp_stagetime_34='%f', cp_stagetime_35='%f' WHERE steamid='%s' AND mapname='%s' WHERE steamid='%s' AND mapname='%s' AND zonegroup='%i';";
