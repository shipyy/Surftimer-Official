...
public void db_viewPlayerOptionsCallback(Handle owner, Handle hndl, const char[] error, any client)
{
	...
	if (SQL_HasResultSet(hndl) && SQL_FetchRow(hndl))
	{
		...
		g_bMinimalHUD[client] = view_as<bool>(SQL_FetchInt(hndl, 28));
		g_MinimalHUDSpeedGradient[client] = SQL_FetchInt(hndl, 29);
		g_bMinimalHUD_CompareWR[client] = view_as<bool>(SQL_FetchInt(hndl, 30));
		g_bMinimalHUD_ComparePB[client] = view_as<bool>(SQL_FetchInt(hndl, 31));
